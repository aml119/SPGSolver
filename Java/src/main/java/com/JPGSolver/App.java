...
public class App {
    ...
    public static void printHelp() {
        ...
        System.out.println("   --randbench/-rb [a b c]    Run an algorithm on random games. The algorithm must be chosen separately.");
        System.out.println("       a: size of the games to generate and solve");
        System.out.println("       b: how any of these games to generate");
        System.out.println("       c: the path to pgsolver/bin/randomgame");
        System.out.println("       note: games will be generated in the root directory of this project. I think. Sorry.");
        System.out.println("   --jurdbench/-jb [a b c]    Run an algorithm on jurdzinski games. The algorithm must be chosen separately.");
        System.out.println("       a: size of the games to generate and solve");
        System.out.println("       b: how any of these games to generate");
        System.out.println("       c: the path to pgsolver/bin/jurdzinskigame");
        System.out.println("       note: games will be generated in the root directory of this project. I think. Sorry.");
        System.out.println("   --ladderbench/-lb [a b c]    Run an algorithm on recursive ladder games. The algorithm must be chosen separately.");
        System.out.println("       a: size of the games to generate and solve");
        System.out.println("       b: how any of these games to generate");
        System.out.println("       c: the path to pgsolver/bin/recursiveladdergame");
        System.out.println("       note: games will be generated in the root directory of this project. I think. Sorry.");
        ...
        System.out.println("       note: this is outdated and can only be used with the parallel zielonka");
        System.out.println();
        System.out.println("And any number of file paths to parity games generated by PGsolver can be added to the end.");
        System.out.println();
    }
